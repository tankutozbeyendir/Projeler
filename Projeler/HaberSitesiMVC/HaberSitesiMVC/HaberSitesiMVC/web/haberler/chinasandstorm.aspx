<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chinasandstorm.aspx.cs" Inherits="habersitesi.haberler.WebForm2" %>
...
<body>
    <div class="loader">
        ...
        <section class="haber">
        	...
        	<h6>Çin'de Halkın 'Dünyanın Sonu Gelmiş Gibi' Şeklinde Tanımladığı Büyük Bir Kum Fırtınası Yaşanıyor</h6>
        	<div class="tarihsaat"><p><i class="far fa-clock"></i>12.04.2021 13:17</p></div> <!-- tarih saat -->
        	...
        	<h6>Çin Ulusal Meteoroloji Merkezi, ülkenin kuzeybatısından başlayarak doğusundaki bölgelere kadar etkisini sürdürmesi beklenen kum fırtınası nedeniyle mavi alarm verildiğini duyurdu.</h6>
        	<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
        	tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
        	quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
        	consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
