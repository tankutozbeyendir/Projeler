<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="youtubevaccine.aspx.cs" Inherits="habersitesi.hotnews.WebForm3" %>
...
<body>
    <div class="loader">
        ...
        <section class="haber">
        	...
        	<h6>Youtube, koronavirüs aşılarıyla ilgili 60 bin video sildi</h6>
        	<div class="tarihsaat"><p><i class="far fa-clock"></i>23.03.2021 19:24</p></div> <!-- tarih saat -->
        	<img src="../img/hottpc4.jpg">
        	...
        	<h6>YouTube, dezenformasyonuyla mücadele çabaları kapsamında, koronavirüs aşıları hakkındaki yanıltıcı videoları sileceğini açıkladı.</h6>
        	<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
        	tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
        	quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
        	consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
