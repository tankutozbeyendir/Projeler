<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="coronavirus.aspx.cs" Inherits="habersitesi.hotnews.WebForm1" %>
...
<body>
        ...
        <section class="haber">
        	...
        	<h6>Dünya genelinde COVID-19 vaka sayısı 124 milyon 396 bin 254'e ulaşırken, 2 milyon 737 bin 748 kişi hayatını kaybetti. Virüse yakalandıktan sonra sağlığına kavuşanların sayısı ise 100 milyonu aştı.</h6>
        	<div class="tarihsaat"><p><i class="far fa-clock"></i>23.03.2021 17:23</p></div> <!-- tarih saat -->
        	<img src="../img/hottpc2.jpg">
        	...
        	<h6>Dünyada 2 milyon 737 bin 748 kişi yaşamını yitirdi.</h6>
        	<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
        	tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
        	quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
        	consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
