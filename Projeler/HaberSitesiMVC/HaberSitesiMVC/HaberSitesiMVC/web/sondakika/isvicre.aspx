<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="isvicre.aspx.cs" Inherits="habersitesi.sondakika.WebForm6" %>
...
<body>
    <div class="loader">
        ...
        <section class="haber">
        	...
        	<h6>İsviçreli eski futbolcu Lichtsteiner, saat firmasında stajyer olarak işe başladı</h6>
        	<div class="tarihsaat"><p><i class="far fa-clock"></i>11.03.2021 19:24</p></div> <!-- tarih saat -->
        	...
        	<img src="../img/isvicre2.jpg">

        	<h6>Futbol hayatı nasıldı?</h6>
        	<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
        	tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
        	quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
        	consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
