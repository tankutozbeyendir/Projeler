<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tinder.aspx.cs" Inherits="habersitesi.haberler.WebForm3" %>
...
<body>
    <div class="loader">
        ...
        <section class="haber">
        	...
        	<h6>Tinder, güvenliğiniz için eşleştiğiniz kişinin sabıkasını öğrenme özelliğini getiriyor</h6>
        	<div class="tarihsaat"><p><i class="far fa-clock"></i>26.03.2021 20:14</p></div> <!-- tarih saat -->
        	<img src="../img/tinder.jpg">
        	...
        	<img src="../img/tinder2.jpg">

        	<h6>Garbo desteğiyle Tinder daha güvenli olacak</h6>
        	<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
        	tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
        	quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
        	consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
