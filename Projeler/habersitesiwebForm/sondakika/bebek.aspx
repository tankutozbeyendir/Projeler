<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bebek.aspx.cs" Inherits="habersitesi.sondakika.WebForm5" %>
...
<body>
    <div class="loader">
        ...
        <section class="haber">
        	...
        	<h6>Bebeğini çöpe atıp ölüme sebep olan anne 23 yıl sonra yakalandı! Kadını DNA'sı ele verdi</h6>
        	<div class="tarihsaat"><p><i class="far fa-clock"></i>20.03.2021 19:24</p></div> <!-- tarih saat -->
        	...
        	<img src="../img/bebek2.jpg">

        	<h6>Şahıs gözaltında.</h6>
        	<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
        	tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
        	quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
        	consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
