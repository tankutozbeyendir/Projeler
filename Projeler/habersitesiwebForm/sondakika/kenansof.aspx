<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kenansof.aspx.cs" Inherits="habersitesi.sondakika.WebForm3" %>
...
<body>
    <div class="loader">
        ...
        <section class="haber">
        	...
        	<h6>2 yaşındaki oğluna motosiklet kullandıran Kenan Sofuoğlu'ndan eleştirilere yanıt: Formula-1'e yetiştirmek isterim</h6>
        	<div class="tarihsaat"><p><i class="far fa-clock"></i>09.03.2021 19:24</p></div> <!-- tarih saat -->
        	...
        	<img src="../img/kenansof2.jpg">

        	<h6>Kenan sofuoğlunun ailesi</h6>
        	<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
        	tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
        	quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
        	consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
