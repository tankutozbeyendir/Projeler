<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dutch.aspx.cs" Inherits="habersitesi.sondakika.WebForm4" %>
...
<body>
    <div class="loader">
        	...
        	<div class="top-top">
        		<div class="login">
        			<a href="../login.aspx" id="log" >
                      ...
                      <asp:Label ID="Label2" runat="server" style="margin-left:10px; text-transform:uppercase;" Text="Label" Visible="False" BorderStyle="NotSet" BorderColor="#E7E3E2" Font-Names="Raleway" Font-Size="Small" Font-Bold="true" Font-Underline="False" ForeColor="#E7E3E2"></asp:Label>:Label>
        ...
        <section class="haber">
        	...
        	<h6>Zehir tacirleri, narkotik köpeğinin koku almaması için uyuşturucu sakladıkları bölgeye benzin dökmüş</h6>
        	<div class="tarihsaat"><p><i class="far fa-clock"></i>13.03.2021 19:24</p></div> <!-- tarih saat -->
        	...
        	<img src="../img/dutc2.jpg">

        	<h6>Belçika kurtlarının geçmişi</h6>
        	<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
        	tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
        	quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
        	consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
